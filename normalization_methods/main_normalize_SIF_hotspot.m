...
for name_i = 1:3
    ...
    for cycle_i = 1:cycle_n
        ...
        filters = Cycle_Num == cycle_i;
        filters_nadir = Cycle_Num == cycle_i & VZA == 0;
        ...
        [Kparms, R2] = kernelParameterRetrieval_h(SZA(filters), VZA(filters), RAA(filters), rSIF760(filters), 2);
        c_factor = CalculateCorrectionFactor_h(SZA(filters), VZA(filters), RAA(filters), Kparms, 2);
        nSIF760_Kernel(filters) = c_factor.*rSIF760(filters);
        
        R2_760(cycle_i) = R2;
        
        [Kparms, R2] = kernelParameterRetrieval_h(SZA(filters), VZA(filters), RAA(filters), rSIF687(filters), 1);
        c_factor = CalculateCorrectionFactor_h(SZA(filters), VZA(filters), RAA(filters), Kparms, 1);
   ...
   %% save 
    save(['results/hotspot_' nameStrings{name_i} '.mat']);
end