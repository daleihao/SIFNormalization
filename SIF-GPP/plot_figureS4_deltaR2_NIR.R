...
# import data
all_datas <- readMat('results/hyper_R2s_wheat.mat')
...
# import data
all_datas <- readMat('results/hyper_R2s_corn.mat')
...
plot_figure
ggsave("plot/figure_S4_deltaR2s_hyper.tiff", plot = plot_figure, width = 25, height = 15, units = "cm", dpi = 600, limitsize = FALSE, compression = "lzw")