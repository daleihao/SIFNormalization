...
# import data
all_datas <- readMat('results/R2s_wheat_vza_40.mat')
...
# import data
all_datas <- readMat('results/R2s_corn_vza_40.mat')
...
plot_figure
ggsave("plot/figure_S5_deltaR2s_vza_40.tiff", plot = plot_figure, width = 25, height = 15, units = "cm", dpi = 600, limitsize = FALSE, compression = "lzw")