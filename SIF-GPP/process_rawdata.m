...
for tt = 1:2
    ...
    save(['results/fitting_obs_' name '.mat'], 'fitReds', 'Reds', ...
        'fitNIRs', 'NIRs', ...
        'fitFarSIFs', 'FarSIFs', ...
        'fitRedSIFs', 'RedSIFs');
    ...
    save(['results/lues_fescs_' name '.mat'], 'nadirFarFescs', 'LUEs', ...
        'nadirRedFescs', 'nadirFarFescs_i0', ...
        'nadirRedFescs_i0');
    ...
    save(['results/sif_gpp_' name '.mat'], 'GPPs', ...
        'FarSIFs', 'nadirFarSIF_rs','nadirFarSIF_ks','totalFarSIF_fpars','totalFarSIF_i0s', ...
        'RedSIFs', 'nadirRedSIF_rs','nadirRedSIF_ks','totalRedSIF_fpars','totalRedSIF_i0s');
    ...
    save([ 'results/CVs_' name '.mat'], 'CVs_far', 'CVs_red');
    save(['results/R2s_' name '.mat'], 'R2s_far', 'R2s_red');
    %%
    %     figure;
    %     subplot(121)
