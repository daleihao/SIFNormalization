...
plot_wheat_far <- ggplot(all_data, mapping = aes(x = variable, y = value, fill = variable)) + ylab(expression(R^2)) +  ggtitle('Wheat - Far-red SIF') + 
...
plot_wheat_red <- ggplot(all_data, mapping = aes(x = variable, y = value, fill = variable)) + ylab(expression(R^2)) +  ggtitle('Wheat - Red SIF') + 
  #geom_violin(aes(fill = variable),trim=False, size = 2.5, show.legend = FALSE, adjust = .8) + 
  stat_boxplot(geom ='errorbar', width = 0.6, size = 0.5, show.legend = FALSE) +
  geom_boxplot(notch=F, size = 0.5, show.legend = FALSE, width = 0.6, outlier.shape = NA) + 
  geom_jitter( stroke = 0, alpha = .5, fill = 'black', size = 2, width = 0.1, show.legend = FALSE) +
...
plot_corn_far <- ggplot(all_data, mapping = aes(x = variable, y = value, fill = variable)) + ylab(expression(R^2)) +  ggtitle('Corn - Far-red SIF') + 
  #geom_violin(aes(fill = variable),trim=False, size = 2.5, show.legend = FALSE, adjust = .8) + 
  stat_boxplot(geom ='errorbar', width = 0.6, size = 0.5, show.legend = FALSE) +
  geom_boxplot(notch=F, size = 0.5, show.legend = FALSE, width = 0.6, outlier.shape = NA) + 
  geom_jitter( stroke = 0, alpha = .5, fill = 'black', size = 2, width = 0.1, show.legend = FALSE) +
...
plot_corn_red <- ggplot(all_data, mapping = aes(x = variable, y = value, fill = variable)) + ylab(expression(R^2)) +  ggtitle('Corn - Red SIF') + 
  #geom_violin(aes(fill = variable),trim=False, size = 2.5, show.legend = FALSE, adjust = .8) + 
  stat_boxplot(geom ='errorbar', width = 0.6, size = 0.5, show.legend = FALSE) +
  geom_boxplot(notch=F, size = 0.5, show.legend = FALSE, width = 0.6, outlier.shape = NA) + 
  geom_jitter( stroke = 0, alpha = .5, fill = 'black', size = 2, width = 0.1, show.legend = FALSE) +
...
plot_figure
ggsave("plot/figure_3_R2s.tiff", plot = plot_figure, width = 25, height = 15, units = "cm", dpi = 600, limitsize = FALSE, compression = "lzw")