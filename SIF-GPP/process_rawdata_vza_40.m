...
for tt = 1:2
    ...
    FarFescs = NIRvs./FPARs;
    RedFescs = Redvs./FPARs;
    ...
    for col_num = 1:25
        filters = VZAs>=39 & VZAs<=41 & GPPs>0 & ...
...
%     suptitle(name)
%     
%     save([ 'results/CVs_' name '_vza_40.mat'], 'CVs_far', 'CVs_red');
    save(['results/R2s_' name '_vza_40.mat'], 'R2s_far', 'R2s_red');
    %%
    %     figure;
    %     subplot(121)
